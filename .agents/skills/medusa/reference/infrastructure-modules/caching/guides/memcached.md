...
In this tutorial, you'll learn how to create a Memcached [Caching Module Provider](https://docs.medusajs.com/resources/infrastructure-modules/caching/providers) for your Medusa application.
...
Refer to the [Caching Module](https://docs.medusajs.com/resources/infrastructure-modules/caching) documentation to learn more about caching in Medusa.
...
Next, establish a connection to Memcached in your module using a [Loader](https://docs.medusajs.com/docs/learn/fundamentals/modules/loaders). A loader is an asynchronous function that runs when the module is initialized. It's useful for setting up connections to external services, such as databases or caching systems.
...
- `container`: The [Module container](https://docs.medusajs.com/docs/learn/fundamentals/modules/container) that holds Framework and module-specific resources.
...
Next, you'll implement the [set method](https://docs.medusajs.com/references/caching-module-provider#set) of the `ICachingProviderService` interface. This method stores a value in the cache with an optional time-to-live (TTL) and associated tags.
...
Next, you'll implement the [get method](https://docs.medusajs.com/references/caching-module-provider#get) of the `ICachingProviderService` interface. This method retrieves a value from the cache either by its key or by associated tags.
...
Finally, you'll implement the [clear method](https://docs.medusajs.com/references/caching-module-provider#clear) of the `ICachingProviderService` interface.
...
First, enable the [Caching Module's feature flag](https://docs.medusajs.com/resources/infrastructure-modules/caching#1-enable-caching-feature-flag) by setting the following environment variable:
...
To verify that the caching is working, you can create a simple [API route](https://docs.medusajs.com/docs/learn/fundamentals/api-routes) that retrieves data with caching.
