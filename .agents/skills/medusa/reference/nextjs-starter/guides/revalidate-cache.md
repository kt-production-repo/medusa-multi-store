...
1. Create a [subscriber](https://docs.medusajs.com/docs/learn/fundamentals/events-and-subscribers) in the Medusa application that listens for the event that triggers the data update. For example, you can listen to the `product.updated` event.
...
Refer to the [Events Reference](https://docs.medusajs.com/references/events) for a full list of events that the Medusa application emits.
