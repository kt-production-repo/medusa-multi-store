...
Follow the step-by-step [Bundled Products Example](https://docs.medusajs.com/resources/recipes/bundled-products/examples/standard) to learn how to implement bundled products in your Medusa application.
...
Medusa provides an [inventory kit](https://docs.medusajs.com/resources/commerce-modules/inventory/inventory-kit) feature that allows you to create bundled products. However, it doesn't support all bundled-product features. For example, you can't set a different price for the bundle, or fulfill items within the same bundle separately.
...
For example, you can define a link between a `Bundle` and a `Product` from the [Product Module](https://docs.medusajs.com/resources/commerce-modules/product). Later, you can retrieve the product associated with the bundle using Query.

- [How to Use Link](https://docs.medusajs.com/docs/learn/fundamentals/module-links/link): Learn how to link data models of different modules.
- [How to Use Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query): Learn how to fetch data across modules with Medusa's Query.
