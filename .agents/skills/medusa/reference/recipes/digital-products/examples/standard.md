...
```ts title="src/modules/digital-product/models/digital-product-media.ts"
import { model } from "@medusajs/framework/utils"
...
The service extends the [service factory](https://docs.medusajs.com/docs/learn/fundamentals/modules/service-factory), which provides basic data-management features.
...
- [Learn more about Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query)
...
```ts title="src/workflows/create-digital-product/steps/create-digital-product.ts"
import {
  createStep,
  StepResponse,
...
```ts title="src/workflows/create-digital-product/steps/create-digital-product-medias.ts"
import {
  createStep,
  StepResponse,
} from "@medusajs/framework/workflows-sdk"
...
```ts title="src/workflows/create-digital-product/index.ts"
import { 
  createWorkflow,
  transform,
  WorkflowResponse,
...
- [What is the Compensation Function](https://docs.medusajs.com/docs/learn/fundamentals/workflows/compensation-function)
- [Learn more about Link functions](https://docs.medusajs.com/docs/learn/fundamentals/module-links/link)
...
Your Medusa application uses the local file module provider by default, which uploads files to a local directory. However, you can use other file module providers, such as the [S3 module provider](https://docs.medusajs.com/resources/infrastructure-modules/file/s3).
...
```ts title="src/api/admin/digital-products/upload/[type]/route.ts"
import {
  AuthenticatedMedusaRequest,
  MedusaResponse,
} from "@medusajs/framework/http"
...
- [How to Create Admin Widgets](https://docs.medusajs.com/docs/learn/fundamentals/admin/widgets)
...
```ts title="src/workflows/delete-product-digital-products/steps/retrieve-digital-products-to-delete.ts"
...
Learn more about subscribers in [this documentation](https://docs.medusajs.com/docs/learn/fundamentals/events-and-subscribers).
...
- `container`: Instance of the [Medusa Container](https://docs.medusajs.com/docs/learn/fundamentals/medusa-container).
...
```ts title="src/workflows/create-digital-product-order/steps/create-digital-product-order.ts"
import {
  createStep,
  StepResponse,
} from "@medusajs/framework/workflows-sdk"
...
```ts title="src/workflows/create-digital-product-order/index.ts"
import {
  createWorkflow,
  transform,
  when,
...
To test out the cart completion, you'll customize the [Next.js Starter Storefront](https://docs.medusajs.com/resources/nextjs-starter) that you installed in the first step to use the new cart completion route to place an order.
...
- [Conditions in Workflows with When-Then](https://docs.medusajs.com/docs/learn/fundamentals/workflows/conditions)
...
```ts title="src/workflows/fulfill-digital-order/index.ts"
import {
  createWorkflow,
  WorkflowResponse,
} from "@medusajs/framework/workflows-sdk"
...
`when` allows you to perform steps based on a condition during execution. Learn more in the [Conditions in Workflows](https://docs.medusajs.com/docs/learn/fundamentals/workflows/conditions) documentation.
...
Check out the [Integrations page](https://docs.medusajs.com/resources/integrations) to find Notification Module Providers.
...
```ts title="src/subscribers/handle-digital-order.ts"
import type {
  SubscriberArgs,
  SubscriberConfig,
...
```ts title="src/api/store/digital-products/[id]/preview/route.ts"
import { 
  MedusaRequest, 
  MedusaResponse,
} from "@medusajs/framework/http"
...
```ts title="src/api/store/customers/me/digital-products/route.ts"
import { 
  AuthenticatedMedusaRequest, 
  MedusaResponse,
} from "@medusajs/framework/http"
...
```ts title="src/api/store/customers/me/digital-products/[mediaId]/download/route.ts"
import { 
  AuthenticatedMedusaRequest, 
  MedusaResponse,
} from "@medusajs/framework/http"
...
- [What are protected API routes](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/protected-routes)

***

## Step 17: Customize Next.js Starter

In this section, you’ll customize the [Next.js Starter storefront](https://docs.medusajs.com/resources/nextjs-starter) to:
...
Aside from customizing the Next.js Starter storefront, you can also create a custom storefront. Check out the [Storefront Development](https://docs.medusajs.com/resources/storefront-development) section to learn how to create a storefront.

### Admin Development

In this recipe, you learned how to customize the admin with UI routes. You can also do further customization using widgets. Learn more in [this documentation](https://docs.medusajs.com/docs/learn/fundamentals/admin).
