...
- **Markdown version of any page**: Users and agents can access the Markdown version of any documentation page by either:
  ...
  - Appending `` to the page URL. For example, the plain text content of the current page is available at [https://docs.medusajs.com/learn/introduction/build-with-llms-ai/ai-friendly-docs](https://docs.medusajs.com/learn/introduction/build-with-llms-ai/ai-friendly-docs).
