...
Medusa only supports PostgreSQL as the underlying database. You can also integrate other databases in a [custom module](https://docs.medusajs.com/learn/fundamentals/modules). For example, the [Loader chapter](https://docs.medusajs.com/learn/fundamentals/modules/loaders#example-register-custom-mongodb-connection) shows how to connect to a MongoDB database through a custom module.
