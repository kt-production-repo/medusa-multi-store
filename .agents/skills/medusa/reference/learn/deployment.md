...
Want Medusa to manage and maintain your infrastructure? [Sign up and learn more about Cloud](https://docs.medusajs.com/cloud)
...
Learn more about worker modes and how to configure them in the [Worker Mode chapter](https://docs.medusajs.com/learn/production/worker-mode).
...
[Sign up and learn more about Cloud](https://docs.medusajs.com/cloud)

To self-host Medusa, the [next chapter](https://docs.medusajs.com/learn/deployment/general) explains the general steps to deploy your Medusa application. Refer to [this reference](https://docs.medusajs.com/resources/deployment) to find how-to deployment guides for general and specific hosting providers.
...
Refer to [this reference](https://docs.medusajs.com/resources/deployment) to find how-to deployment guides for specific hosting providers.
