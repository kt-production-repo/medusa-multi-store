...
- You pass in the `fields` property:
  - The link table's columns, such as `id`, `product_id`, and `post_id`. You can also select [custom columns](https://docs.medusajs.com/learn/fundamentals/module-links/custom-columns) that you defined in the link table.
