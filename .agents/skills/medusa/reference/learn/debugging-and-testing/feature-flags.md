...
```ts title="src/api/routes/custom.ts"
...
For client customizations, you can use the [List Feature Flags API Route](https://docs.medusajs.com/api/admin/feature-flags/list-feature-flags) to check the status of feature flags.
...
```tsx title="src/admin/widgets/product-details.tsx"
