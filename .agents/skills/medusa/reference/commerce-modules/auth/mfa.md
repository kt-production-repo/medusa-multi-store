...
- [Medusa v2.15.5+](https://docs.medusajs.com/docs/learn/update)
...
- [Create a Custom MFA Provider](https://docs.medusajs.com/references/auth/mfa-module-provider)
- [Create a Custom Recovery Code Provider](https://docs.medusajs.com/references/auth/recovery-code-mfa-module-provider)
...
Refer to the [Events Reference](https://docs.medusajs.com/references/auth/events) for the full list of Auth Module events.
