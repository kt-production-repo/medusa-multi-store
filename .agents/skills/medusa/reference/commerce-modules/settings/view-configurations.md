...
The [ViewConfiguration](https://docs.medusajs.com/references/settings/models/ViewConfiguration) data model stores a view's customizations in its `configuration` property, which includes:
...
Learn how in the [Configure View Configurations](https://docs.medusajs.com/resources/commerce-modules/settings/configure-view-configurations) guide.
