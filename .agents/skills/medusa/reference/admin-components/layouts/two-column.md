...
As of Medusa v2.16.0, Medusa provides a [LayoutComposer](https://docs.medusajs.com/resources/admin-components/components/layout-composer) component that you can use to create layouts, including the two column layout.
...
This UI route also uses [Container](https://docs.medusajs.com/resources/admin-components/components/container) and [Header](https://docs.medusajs.com/resources/admin-components/components/header) custom components.
