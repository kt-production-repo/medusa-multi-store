...
1. Create forms, created using the [FocusModal UI component](https://docs.medusajs.com/ui/components/focus-modal).
2. Edit or update forms, created using the [Drawer UI component](https://docs.medusajs.com/ui/components/drawer).
...
You can replace the content of the function with sending a request to Medusa's routes. Refer to [this guide](https://docs.medusajs.com/docs/learn/fundamentals/admin/tips#send-requests-to-api-routes) for more details on how to do that.
...
This component uses the [Container](https://docs.medusajs.com/resources/admin-components/components/container) and [Header](https://docs.medusajs.com/resources/admin-components/components/header) custom components.
