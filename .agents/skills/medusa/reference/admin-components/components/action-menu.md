...
The `ActionMenu` component shows a three-dots icon (or `EllipsisHorizontal`) from the [Medusa Icons package](https://docs.medusajs.com/ui/icons/overview) in a button.
...
You can also use the action menu in the [Header](https://docs.medusajs.com/resources/admin-components/components/header) component as part of its actions.
