    ...
    <div>
      <div className="small:hidden" data-testid="mobile-account-nav">
        {route !== `/${countryCode}/account` ? (
          <LocalizedClientLink
            href="/account"
            className="flex items-center gap-x-2 text-small-regular py-2 nav-link"
          ...
          <>
            <div className="text-xl font-bold text-grey-90 mb-4 px-8">
              ...
              <ul>
                <li>
                  <LocalizedClientLink
                    ...
                    className="flex items-center justify-between py-4 border-b border-grey-10 px-8 nav-link"
      ...
      <div className="hidden small:block" data-testid="account-nav">
        <div>
          <div className="pb-6">
            <h3 className="text-lg font-bold text-grey-90">Account</h3>
          </div>
          <div className="text-base">
            <ul className="flex mb-0 justify-start items-start flex-col gap-y-1">
              ...
              <li className="mt-4">
                <button
                  type="button"
                  onClick={handleLogout}
                  className="text-grey-50 hover:text-brand-dark transition-colors"
                  data-testid="logout-button"
                >
                  Log out
                </button>
