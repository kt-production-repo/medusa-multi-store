    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+8px)] right-0 bg-white border border-border rounded-2xl shadow-xl w-[420px] text-ui-fg-base"
          ...
          >
            ...
            {cartState && cartState.items?.length ? (
              <>
                ...
                <div className="p-4 flex flex-col gap-y-3 border-t border-border">
              ...
              <div>
                <div className="flex py-16 flex-col gap-y-4 items-center justify-center">
                  <ShoppingBag className="w-8 h-8 text-grey-30" />
                  <span className="text-sm text-grey-50">Your shopping bag is empty.</span>
                  <div>
