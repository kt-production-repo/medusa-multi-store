...
For example, the [Create Product API Route](https://docs.medusajs.com/api/admin/products/create-product) accepts an `additional_data` parameter. If you have a data model linked to it, you consume the `productsCreated` hook to create a record of the data model using the custom data and link it to the product.
...
- Campaigns
  - [Create Campaign](https://docs.medusajs.com/api/admin/campaigns/create-campaign)
  - [Update Campaign](https://docs.medusajs.com/api/admin/campaigns/update-a-campaign)
- Cart
  - [Create Cart](https://docs.medusajs.com/api/store/carts/create-cart)
...
- Customers
  - [Create Customer](https://docs.medusajs.com/api/admin/customers/create-customer)
  - [Update Customer](https://docs.medusajs.com/api/admin/customers/update-a-customer)
  - [Create Address](https://docs.medusajs.com/api/admin/customers/add-address)
  - [Update Address](https://docs.medusajs.com/api/admin/customers/update-address)
- Draft Orders
  - [Create Draft Order](https://docs.medusajs.com/api/admin/draft-orders/create-draft-order)
- Orders
  - [Complete Orders](https://docs.medusajs.com/api/admin/orders/complete-order)
  - [Cancel Order's Fulfillment](https://docs.medusajs.com/api/admin/orders/cancel-fulfillment)
...
- Products
  ...
  - [Create Product Variant](https://docs.medusajs.com/api/admin/products/create-variant)
  - [Update Product Variant](https://docs.medusajs.com/api/admin/products/update-variant)
- Product Tags
