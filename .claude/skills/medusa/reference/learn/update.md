...
Medusa's current version is v2.19. Read the [Release Notes](https://github.com/medusajs/medusa/releases/tag/v2.19.0).
...
This will show you the installed version of Medusa and the [Medusa CLI tool](https://docs.medusajs.com/resources/medusa-cli), which should be the same.
