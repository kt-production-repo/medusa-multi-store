...
In the previous chapters, you've followed the [brand example](https://docs.medusajs.com/learn/customization/custom-features) to learn important concepts related to:

- [Creating modules](https://docs.medusajs.com/learn/customization/custom-features/module).
- [Implementing commerce features in workflows](https://docs.medusajs.com/learn/customization/custom-features/workflow).
- [Exposing those features in API routes](https://docs.medusajs.com/learn/customization/custom-features/api-route).
- [Customizing the Medusa Admin dashboard with Admin Extensions](https://docs.medusajs.com/learn/customization/customize-admin).
- [Integrating third-party systems](https://docs.medusajs.com/learn/customization/integrate-systems).
...
Refer to the [Plugins](https://docs.medusajs.com/learn/fundamentals/plugins) chapter to learn more about plugins and how to create them.
