# Migrate from Shopify to Medusa

In this chapter, you'll learn how to use the [Medusa MCP server](https://docs.medusajs.com/learn/introduction/build-with-llms-ai/mcp-server) to migrate your store's data from Shopify into Medusa.
