...
If you're using [Medusa v2.4.0+](https://github.com/medusajs/medusa/releases/tag/v2.4.0), it's recommended to use the [Data Table](https://docs.medusajs.com/resources/admin-components/components/data-table) component instead as it provides features for sorting, filtering, pagination, and more with a simpler API.
...
The `Table` component uses the component from the [UI package](https://docs.medusajs.com/ui/components/table), with additional styling and rendering of data.
...
Assuming you've set up the JS SDK as explained in [this guide](https://docs.medusajs.com/resources/js-sdk), create the UI route `src/admin/routes/custom/page.tsx` with the following content:
...
You can change the query to send a request to a custom API route as explained in [this guide](https://docs.medusajs.com/resources/js-sdk#send-requests-to-custom-routes).
...
Aside from the `Table` component, this UI route also uses the [SingleColumnLayout](https://docs.medusajs.com/resources/admin-components/layouts/single-column), [Container](https://docs.medusajs.com/resources/admin-components/components/container), and [Header](https://docs.medusajs.com/resources/admin-components/components/header) custom component.
