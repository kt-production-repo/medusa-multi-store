...
Learn how to install and use these packages either for [Medusa Admin](https://docs.medusajs.com/ui/installation/medusa-admin-extension) customizations or a [standalone project](https://docs.medusajs.com/ui/installation/standalone-project).
