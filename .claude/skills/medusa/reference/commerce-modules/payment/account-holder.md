...
The Medusa application creates a link between the [Customer](https://docs.medusajs.com/references/customer/models/Customer) data model of the [Customer Module](https://docs.medusajs.com/resources/commerce-modules/customer) and the `AccountHolder` data model of the Payment Module.
...
Learn more about this link in the [Link to Other Modules](https://docs.medusajs.com/resources/commerce-modules/payment/links-to-other-modules) guide.
