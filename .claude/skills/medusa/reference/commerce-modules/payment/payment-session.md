...
The `PaymentSession` data model has a `data` property used to store that data. It's set by the [payment provider in Medusa](https://docs.medusajs.com/resources/commerce-modules/payment/payment-provider) when the payment is initialized.
