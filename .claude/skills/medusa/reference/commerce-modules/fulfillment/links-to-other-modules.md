...
The [Order Module](https://docs.medusajs.com/resources/commerce-modules/order) provides order-management functionalities.
...
To retrieve the order of a fulfillment with [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query), pass `order.*` in `fields`:
...
To retrieve the price set of a shipping option with [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query), pass `price_set.*` in `fields`:
...
To retrieve the products of a shipping profile with [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query), pass `products.*` in `fields`:
...
To retrieve the stock location of a fulfillment set with [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query), pass `location.*` in `fields`:
