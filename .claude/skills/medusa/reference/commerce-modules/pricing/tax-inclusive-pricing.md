...
The [PricePreference data model](https://docs.medusajs.com/references/pricing/models/PricePreference) holds the tax-inclusive setting for a context. It has two properties that indicate the context:
...
As mentioned in the [Price Calculation documentation](https://docs.medusajs.com/resources/commerce-modules/pricing/price-calculation#calculation-context), The `calculatePrices` method accepts as a parameter a calculation context.
...
Learn more about the returned properties in [this guide](https://docs.medusajs.com/resources/commerce-modules/pricing/price-calculation#returned-price-object).
...
Learn more in the [Tax-Inclusive Promotions](https://docs.medusajs.com/resources/commerce-modules/promotion/promotion-taxes) guide.
