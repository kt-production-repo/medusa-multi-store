...
In this guide, you'll learn how to retrieve cart totals in your Medusa application using [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query).
...
Refer to the [Retrieve Cart Totals in Storefront](https://docs.medusajs.com/resources/storefront-development/cart/totals) guide for a storefront-specific approach.
...
The shape of the returned `cart` object depends on where you access it. Server-side, each total is a [BigNumber](https://docs.medusajs.com/docs/learn/fundamentals/data-models/big-numbers) instance. In an API route's response, each total is a plain number.
...
When you retrieve cart totals with Query in server-side code, computed totals like `total` are instances of [BigNumber](https://docs.medusajs.com/docs/learn/fundamentals/data-models/big-numbers), not plain numbers.
