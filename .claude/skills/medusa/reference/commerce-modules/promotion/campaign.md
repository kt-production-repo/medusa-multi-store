...
Refer to this [Medusa Admin User Guide](https://docs.medusajs.com/user-guide/promotions/campaigns) to learn how to manage campaigns using the dashboard.

## What is a Campaign?

A [Campaign](https://docs.medusajs.com/references/promotion/models/Campaign) groups [promotions](https://docs.medusajs.com/resources/commerce-modules/promotion/concepts#what-is-a-promotion) under the same conditions, such as start and end dates.
...
Each campaign can have a budget represented by the [CampaignBudget data model](https://docs.medusajs.com/references/promotion/models/CampaignBudget). The budget limits how many times a promotion can be used.
