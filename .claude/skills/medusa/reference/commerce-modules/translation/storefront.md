...
You can retrieve the list of locales available in your store using the [List Locales Store API route](https://docs.medusajs.com/api/store/locales/list-locales). You can display this list to customers, allowing them to select their preferred language.
...
Learn more in the [Localization](https://docs.medusajs.com/resources/storefront-development/localization) storefront guide.
...
Learn more in the [List Products](https://docs.medusajs.com/resources/storefront-development/products/list#retrieve-translations-for-products) storefront guide.
...
Learn more in the [Create Cart](https://docs.medusajs.com/resources/storefront-development/cart/create) and [Update Cart](https://docs.medusajs.com/resources/storefront-development/cart/update) storefront guides.
