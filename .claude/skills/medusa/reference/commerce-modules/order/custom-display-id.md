...
By default, Medusa stores the display ID of orders in the `display_id` property of the [Order data model](https://docs.medusajs.com/references/order/models/Order). The display ID is a serial integer that starts at 1 and increments with each new order.
