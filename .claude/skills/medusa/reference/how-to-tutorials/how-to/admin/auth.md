...
By default, the Medusa Admin allows users to authenticate using their email and password. Medusa uses the [Emailpass Authentication Provider](https://docs.medusajs.com/resources/commerce-modules/auth/auth-providers/emailpass) to handle this authentication method.
...
1. Create a [custom Authentication Module Provider](https://docs.medusajs.com/references/auth/provider) that integrates the third-party provider. For example, you can create a provider that integrates with Okta.
...
Refer to the [Create Custom Authentication Module Provider](https://docs.medusajs.com/references/auth/provider) guide to learn how to create a custom Authentication Module Provider.

### Enable Custom Authentication Provider for Admin Users

By default, registered Authentication Module Providers can be used for all [actor types](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types). This means both admin users and customers can authenticate through the provider.
...
Refer to the [Authentication Module Providers](https://docs.medusajs.com/resources/commerce-modules/auth/auth-providers#configure-allowed-auth-providers-of-actor-types) guide to learn more about configuring allowed authentication providers for actor types.
...
Refer to the [JS SDK Authentication guide](https://docs.medusajs.com/resources/js-sdk/auth/overview) to learn more about configuring authentication in the Medusa JS SDK.

***

## Step 3: Create User API Route

Next, you need to create an [API route](https://docs.medusajs.com/docs/learn/fundamentals/api-routes) with a [workflow](https://docs.medusajs.com/docs/learn/fundamentals/workflows) that handles creating the admin user after they authenticate through the third-party provider.
...
- `auth_identity_id`: The ID of the auth identity created by the custom Authentication Module Provider. Refer to the [Auth Identities](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types) guide to learn more.
...
Finally, you need to apply the authentication [middleware](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/middlewares) to the API route to ensure that only authenticated users can access it.
...
Refer to the [Protected Routes](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/protected-routes) guide to learn more about protecting API routes with the `authentication` middleware.
...
- The user's auth identity was authenticated by the custom Authentication Module Provider. You use [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query) to retrieve the user's auth identity with its provider identities, then check whether the custom provider is one of the providers. If not, you throw an unauthorized error.
...
Finally, you need to add a [widget](https://docs.medusajs.com/docs/learn/fundamentals/admin/widgets) to the Medusa Admin login page that provides the option to log in through the third-party provider.
