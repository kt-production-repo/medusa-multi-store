...
When you install a Medusa application, you get a fully-fledged commerce platform with a Framework for customization. The Medusa application's commerce features are built around [Commerce Modules](https://docs.medusajs.com/resources/commerce-modules), which are available out-of-the-box. These features include cart and order management capabilities.
...
The Medusa Admin dashboard's pages are customizable to insert [widgets](https://docs.medusajs.com/docs/learn/fundamentals/admin/widgets) of custom content in predefined injection zones. You create these widgets as React components that allow admin users to perform custom actions.
...
```tsx title="src/admin/widgets/order-gift-items-widget.tsx"
...
```ts title="Fulfillment Module Provider's Service"
