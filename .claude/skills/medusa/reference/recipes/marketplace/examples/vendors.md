...
If your use case requires linking the vendor to other data models, such as `SalesChannel` from the [Sales Channel Module](https://docs.medusajs.com/resources/commerce-modules/sales-channel), define those links in a similar manner.
...
- [How to Define Module Links](https://docs.medusajs.com/docs/learn/fundamentals/module-links)
...
An [actor type](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types#actor-types) is a type of user that can send an authenticated requests. Medusa has two default actor types: `customer` for customers, and `admin` for admin users.
...
2. Create the user. This requires creating the user in the database, and associate an [auth identity](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types#what-is-an-auth-identity) with that user. An auth identity allows this user to later send authenticated requests.
...
- [Auth Identities and Actor Types](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types)
...
```ts title="src/workflows/marketplace/create-vendor/steps/create-vendor.ts"
import { 
  createStep,
  StepResponse,
...
2. An async function that receives two parameters:
   ...
   - The [Medusa container](https://docs.medusajs.com/docs/learn/fundamentals/medusa-container), which is a registry of Framework and commerce tools that you can access in the step.
...
```ts title="src/workflows/marketplace/create-vendor/steps/create-vendor-admin.ts"
import { 
  createStep,
  StepResponse,
} from "@medusajs/framework/workflows-sdk"
...
```ts title="src/workflows/marketplace/create-vendor/index.ts"
import { 
  createWorkflow,
  WorkflowResponse,
  transform,
...
4. `useQueryGraphStep` to retrieve the created vendor with its admins using [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query). Query allows you to retrieve data across modules.
...
- [What is an Actor Type](https://docs.medusajs.com/resources/commerce-modules/auth/auth-identity-and-actor-types)
- [How to Create an Actor Type](https://docs.medusajs.com/resources/commerce-modules/auth/create-actor-type)
- [What is a Compensation Function](https://docs.medusajs.com/docs/learn/fundamentals/workflows/compensation-function)
...
Don't include a trailing slash at the end of the URL. Learn more [here](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/middlewares).
...
- [How to Create a Middleware](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/middlewares)
- [Learn more about the /auth route](https://docs.medusajs.com/resources/commerce-modules/auth/authentication-route)
...
Refer to the [Link](https://docs.medusajs.com/docs/learn/fundamentals/module-links/link) documentation to learn more about creating links.
...
- [How to use Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query)
...
```ts title="src/workflows/marketplace/create-vendor-orders/index.ts"
import { 
  createWorkflow,
  when,
  WorkflowResponse,
...
To test this out, it’s recommended to install the [Next.js Starter storefront](https://docs.medusajs.com/resources/nextjs-starter).
...
Refer to the [JS SDK](https://docs.medusajs.com/resources/js-sdk) documentation to learn more about using it.
...
```ts title="src/api/vendors/orders/route.ts"
...
[Learn more about module links](https://docs.medusajs.com/docs/learn/fundamentals/module-links).

### Storefront Development

Medusa provides a Next.js Starter storefront, which you can customize to fit your specific use case.

You can also create a custom storefront. Check out the [Storefront Development](https://docs.medusajs.com/resources/storefront-development) section to learn how to create a storefront.

### Admin Development

The Medusa Admin is extendable, allowing you to add custom widgets to existing pages or create entirely new pages. For example, you can add a new page showing the list of vendors. Learn more about it in [this documentation](https://docs.medusajs.com/docs/learn/fundamentals/admin).
