...
Next, you'll configure the [Stripe Module Provider](https://docs.medusajs.com/resources/commerce-modules/payment/payment-provider/stripe) in your Medusa application. The Stripe Module Provider allows you to accept payments through Stripe in your Medusa application.
...
For more details about other available options and the webhook URLs that Medusa provides, refer to the [Stripe Module Provider](https://docs.medusajs.com/resources/commerce-modules/payment/payment-provider/stripe) documentation.
...
Learn more about the webhook API routes and how to configure them in the [Stripe Module Provider](https://docs.medusajs.com/resources/commerce-modules/payment/payment-provider/stripe) guide.
