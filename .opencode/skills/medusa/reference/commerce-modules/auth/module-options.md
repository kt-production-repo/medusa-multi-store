...
Refer to [Medusa's configuration guide](https://docs.medusajs.com/docs/learn/configurations/medusa-config#httpauthCors) to learn more about the `authCors` configuration.
...
This feature is available in [Medusa v2.15.5](https://docs.medusajs.com/docs/learn/update) and above.
...
Learn more about the `authMethodsPerActor` configuration in [this guide](https://docs.medusajs.com/resources/commerce-modules/auth/auth-providers#configure-allowed-auth-providers-of-actor-types).
