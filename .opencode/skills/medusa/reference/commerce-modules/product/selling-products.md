...
The Medusa application defines a link between the `Product` data model and the [ShippingProfile](https://docs.medusajs.com/resources/commerce-modules/fulfillment/concepts#shipping-profile) data model in the [Fulfillment Module](https://docs.medusajs.com/resources/commerce-modules/fulfillment), allowing you to associate a product with a shipping profile.
...
A product variant whose inventory is managed by Medusa (its `manage_inventory` property is enabled) has an [inventory item](https://docs.medusajs.com/resources/commerce-modules/inventory/concepts#inventoryitem).
...
Refer to the [Product Variant Inventory](https://docs.medusajs.com/resources/commerce-modules/product/variant-inventory) guide to learn more.
...
- Create a custom [API route](https://docs.medusajs.com/docs/learn/fundamentals/api-routes) that checks whether the cart has items that require shipping.
