...
In this guide, you'll learn how to retrieve order totals in your Medusa application using [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query).
...
Refer to the [Order Confirmation in Storefront](https://docs.medusajs.com/resources/storefront-development/checkout/order-confirmation#show-order-totals) guide for a storefront-specific approach.
...
The shape of the returned `order` object depends on where you access it. Server-side, each total is a [BigNumber](https://docs.medusajs.com/docs/learn/fundamentals/data-models/big-numbers) instance. In an API route's response, each total is a plain number.
...
When you retrieve order totals with Query in server-side code, computed totals like `total` are instances of [BigNumber](https://docs.medusajs.com/docs/learn/fundamentals/data-models/big-numbers), not plain numbers.
...
Learn more in the [Big Numbers](https://docs.medusajs.com/docs/learn/fundamentals/data-models/big-numbers) documentation.
