...
The `providers` option is an array of either [tax module providers](https://docs.medusajs.com/resources/commerce-modules/tax/tax-provider) or path to a file that defines a tax provider.
