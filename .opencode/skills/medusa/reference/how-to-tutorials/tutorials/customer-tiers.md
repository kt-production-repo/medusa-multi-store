...
In Medusa, you can build custom features in a [module](https://docs.medusajs.com/docs/learn/fundamentals/modules). A module is a reusable package with functionalities related to a single feature or domain. Medusa integrates the module into your application without affecting your setup.
...
- A [workflow](https://docs.medusajs.com/docs/learn/fundamentals/workflows) with steps to create a tier.
- An [API route](https://docs.medusajs.com/docs/learn/fundamentals/api-routes) that exposes the workflow's functionality to client applications.
...
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the created tier with its rules.
...
- Use [when-then](https://docs.medusajs.com/docs/learn/fundamentals/workflows/conditions) to check whether the promotion ID is provided and retrieve the promotion to validate that it exists.
  ...
  - This step uses [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query) under the hood to retrieve data across modules.
- Create the tier using the `createTierStep`.
- Use [when-then](https://docs.medusajs.com/docs/learn/fundamentals/workflows/conditions) to conditionally create tier rules if they're provided using the `createTierRulesStep`.
...
In workflows, you need `when-then` to check conditions based on execution values. Learn more in the [Conditions](https://docs.medusajs.com/docs/learn/fundamentals/workflows/conditions) workflow documentation.
...
To ensure incoming request bodies are validated, you need to apply a [middleware](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/middlewares).
...
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the tier to update.
- [updateTierStep](#updateTierStep): Update the tier.
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the updated tier with rules.
...
In workflows, you need `transform` to prepare data based on execution values. Learn more in the [Data Manipulation](https://docs.medusajs.com/docs/learn/fundamentals/workflows/variable-manipulation) workflow documentation.
...
Notice that you use the `query.index` method. This method is similar to `query.graph` but allows you to filter by linked records using the [Index Module](https://docs.medusajs.com/docs/learn/fundamentals/module-links/index-module).
...
The [Index Module](https://docs.medusajs.com/docs/learn/fundamentals/module-links/index-module) is a tool for performing high-performance queries across modules, such as filtering linked modules.
...
Refer to the [Index Module](https://docs.medusajs.com/docs/learn/fundamentals/module-links/index-module) documentation to learn more.
...
- A [subscriber](https://docs.medusajs.com/docs/learn/fundamentals/events-and-subscribers) that listens to the order placement event and executes the workflow.
...
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the details of the order with its customer and tier.
- [validateCustomerStep](#validateCustomerStep): Validate that the customer is a registered customer.
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the completed orders for the customer in the same currency.
...
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve the details of the cart with its customer and tier.
...
When a customer adds a promotion to the cart, the storefront sends a request to the [Add Promotions API Route](https://docs.medusajs.com/api/store/carts/add-promotions), which executes the [updateCartPromotionsWorkflow](https://docs.medusajs.com/references/medusa-workflows/updateCartPromotionsWorkflow).

To ensure that customers don't add promotions that belong to different tiers, you can consume the `validate` [hook](https://docs.medusajs.com/docs/learn/fundamentals/workflows/workflow-hooks) of the `updateCartPromotionsWorkflow`. A hook is a specific point in a workflow where you can inject custom functionality.
...
If you're new to Medusa, check out the [main documentation](https://docs.medusajs.com/docs/learn) for a more in-depth understanding of the concepts you've used in this guide and more.
