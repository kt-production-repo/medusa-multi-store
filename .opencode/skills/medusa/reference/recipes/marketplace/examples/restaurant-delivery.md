...
- [How to Define Links](https://docs.medusajs.com/docs/learn/fundamentals/module-links)
...
```ts title="src/workflows/restaurant/steps/create-restaurant.ts"
...
If you’re calling this API route from a frontend client, make sure to set the [CORS middleware](https://docs.medusajs.com/docs/learn/fundamentals/api-routes/cors) on it since it’s not under the `/store` or `/admin` route prefixes.
...
- [What is and how to use it](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query)
- [How to Retrieve Prices for Product Variants](https://docs.medusajs.com/resources/commerce-modules/product/guides/price)
...
```ts title="src/workflows/user/workflows/create-user.ts"
...
```ts title="src/api/users/route.ts"
import { 
...
```ts title="src/workflows/restaurant/workflows/create-restaurant-products.ts"
import { 
...
```ts title="src/api/restaurants/[id]/products/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { 
  AdminCreateProduct,
...
```ts title="src/workflows/delivery/steps/create-delivery.ts"
import { StepResponse, createStep } from "@medusajs/framework/workflows-sdk"
import { DELIVERY_MODULE } from "../../../modules/delivery"
import DeliveryModuleService from "../../../modules/delivery/service"
...
```ts title="src/workflows/delivery/workflows/create-delivery.ts"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
...
This workflow will be a [long-running workflow](https://docs.medusajs.com/docs/learn/fundamentals/workflows/long-running-workflow) that runs asynchronously in the background. Its async steps only succeed once an outside action sets its status, allowing the workflow to move to the next step.
...
```ts title="src/workflows/delivery/steps/set-transaction-id.ts"
import { StepResponse, createStep } from "@medusajs/framework/workflows-sdk"
import { DELIVERY_MODULE } from "../../../modules/delivery"
import DeliveryModuleService from "../../../modules/delivery/service"
...
```ts title="src/workflows/delivery/steps/notify-restaurant.ts"
import {
  Modules,
  ContainerRegistrationKeys,
} from "@medusajs/framework/utils"
...
```ts title="src/workflows/delivery/steps/create-fulfillment.ts"
...
```ts title="src/workflows/delivery/workflows/handle-delivery.ts"
import {
  WorkflowResponse,
  createWorkflow,
} from "@medusajs/framework/workflows-sdk"
...
- [Long-Running Workflows](https://docs.medusajs.com/docs/learn/fundamentals/workflows/long-running-workflow)
...
```ts title="src/api/store/deliveries/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
import { z } from "@medusajs/framework/zod"
import { DELIVERY_MODULE } from "../../../modules/delivery"
...
```ts title="src/workflows/delivery/steps/update-delivery.ts"
import { createStep, StepResponse } from "@medusajs/framework/workflows-sdk"
import { DELIVERY_MODULE } from "../../../modules/delivery"
...
```ts title="src/workflows/delivery/steps/set-step-success.ts"
import {
  Modules,
...
```ts title="src/workflows/delivery/steps/set-step-failed.ts"
import {
  Modules,
  TransactionHandlerType,
} from "@medusajs/framework/utils"
...
```ts title="src/workflows/delivery/workflows/update-delivery.ts"
import {
  createWorkflow,
  WorkflowResponse,
  when,
...
```ts title="src/api/deliveries/[id]/accept/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
...
```ts title="src/api/utils/is-delivery-restaurant.ts"
import { 
  AuthenticatedMedusaRequest, 
  MedusaNextFunction, 
  MedusaResponse,
...
```ts title="src/workflows/delivery/workflows/claim-delivery.ts"
import {
  createWorkflow,
  WorkflowResponse,
} from "@medusajs/framework/workflows-sdk"
...
```ts title="src/api/deliveries/[id]/claim/route.ts"
import { 
  AuthenticatedMedusaRequest, 
  MedusaRequest, 
  MedusaResponse,
...
```ts title="src/api/deliveries/[id]/prepare/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
import { DeliveryStatus } from "../../../../modules/delivery/types"
import { 
...
```ts title="src/api/deliveries/[id]/ready/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
import { DeliveryStatus } from "../../../../modules/delivery/types"
import { 
...
```ts title="src/api/deliveries/[id]/pick-up/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
import { DeliveryStatus } from "../../../../modules/delivery/types"
import { 
...
```ts title="src/api/utils/is-delivery-driver.ts"
import { 
  AuthenticatedMedusaRequest, 
  MedusaNextFunction, 
  MedusaResponse,
...
```ts title="src/api/deliveries/[id]/complete/route.ts"
import { MedusaRequest, MedusaResponse } from "@medusajs/framework/http"
import { MedusaError } from "@medusajs/framework/utils"
import { DeliveryStatus } from "../../../../modules/delivery/types"
import { 
...
You can use a custom Next.js project, or use Medusa's Next.js Starter storefront. If you haven't installed the Next.js Starter storefront in the first step, refer to [this documentation](https://docs.medusajs.com/resources/nextjs-starter#approach-2-install-separately) to learn how to install it.
...
```ts title="src/api/deliveries/[id]/subscribe/route.ts"
import { 
  MedusaRequest, 
  MedusaResponse,
} from "@medusajs/framework/http"
...
The Medusa Admin is extendable, allowing you to add widgets to existing pages or create new pages. Learn more about it in [this documentation](https://docs.medusajs.com/docs/learn/fundamentals/admin).
