# Ask Medusa Questions with the MCP Server

In this chapter, you'll learn how to use the [Medusa MCP server](https://docs.medusajs.com/learn/introduction/build-with-llms-ai/mcp-server) to let your AI agent answer questions from the official Medusa documentation.
...
After [connecting to the Medusa MCP server](https://docs.medusajs.com/learn/introduction/build-with-llms-ai/mcp-server#connect-to-the-medusa-mcp-server), just ask your question. Your AI agent calls the tool whenever answering requires Medusa knowledge, and you don't need to invoke it explicitly.
...
If the tool can't find relevant documentation for your question, that's a documentation gap worth reporting. Ask your agent to [submit feedback](https://docs.medusajs.com/learn/introduction/build-with-llms-ai/mcp-server/submit-feedback) so the Medusa team can add coverage.
