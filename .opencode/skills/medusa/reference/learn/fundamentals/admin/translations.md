...
Medusa Admin translations apply to the interface only. To translate content like product data, check out the [Translations user guide](https://docs.medusajs.com/user-guide/settings/translations).
