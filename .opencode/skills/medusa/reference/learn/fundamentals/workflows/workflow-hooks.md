...
Now, when a product is created using the [Create Product API route](https://docs.medusajs.com/api/admin/products/create-product), your hook handler runs after the product is created.
