...
To store an array of strings, use the [array property type](https://docs.medusajs.com/learn/fundamentals/data-models/properties#array) instead, which stores the value in a `text[]` column.
