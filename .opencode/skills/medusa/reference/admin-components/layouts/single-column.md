...
As of Medusa v2.16.0, Medusa provides a [LayoutComposer](https://docs.medusajs.com/resources/admin-components/components/layout-composer) component that you can use to create layouts, including the single column layout.
...
This UI route also uses a [Container](https://docs.medusajs.com/resources/admin-components/components/container) and a [Header]() custom components.
