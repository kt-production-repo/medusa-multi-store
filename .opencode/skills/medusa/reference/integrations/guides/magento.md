...
In this tutorial, you'll learn how to build a [plugin](https://docs.medusajs.com/docs/learn/fundamentals/plugins) that migrates data, such as products, from Magento to Medusa.
...
Refer to the [Plugins](https://docs.medusajs.com/docs/learn/fundamentals/plugins) documentation to learn more about plugins.
...
Refer to the [Modules](https://docs.medusajs.com/docs/learn/fundamentals/modules) documentation to learn more about modules.
...
The service's constructor accepts as a first parameter the [Module Container](https://docs.medusajs.com/docs/learn/fundamentals/modules/container), which allows you to access resources available for the module. As a second parameter, it accepts the module's options.
...
Medusa supports integrating third-party services, such as [S3](https://docs.medusajs.com/resources/infrastructure-modules/file/s3), in a File Module Provider. Refer to the [File Module](https://docs.medusajs.com/resources/infrastructure-modules/file) documentation to find other module providers and how to create a custom provider.
...
Refer to the [Workflows](https://docs.medusajs.com/docs/learn/fundamentals/workflows) documentation to learn more about workflows.
...
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve Medusa store details, which you'll need when creating the products.
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve a shipping profile, which you'll associate the created products with.
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve Magento products that are already in Medusa to update them, instead of creating them.
- [useQueryGraphStep](https://docs.medusajs.com/references/helper-steps/useQueryGraphStep): Retrieve existing product options from Medusa.
- [createProductOptionsWorkflow](https://docs.medusajs.com/references/medusa-workflows/createProductOptionsWorkflow): Create missing product options in Medusa.
- [createProductsWorkflow](https://docs.medusajs.com/references/medusa-workflows/createProductsWorkflow): Create products in the Medusa application.
- [updateProductsWorkflow](https://docs.medusajs.com/references/medusa-workflows/updateProductsWorkflow): Update existing products in the Medusa application.
...
If you get a type error on resolving the Magento Module, run the Medusa application once with the `npm run dev` or `yarn dev` command to generate the necessary type definitions, as explained in the [Automatically Generated Types guide](https://docs.medusajs.com/docs/learn/fundamentals/generated-types).
...
You use the `useQueryGraphStep` step to retrieve the store details and shipping profiles. `useQueryGraphStep` is a Medusa step that wraps [Query](https://docs.medusajs.com/docs/learn/fundamentals/module-links/query), allowing you to use it in a workflow. Query is a tool that retrieves data across modules.
...
Refer to the [Workflows](https://docs.medusajs.com/docs/learn/fundamentals/workflows/constructor-constraints) documentation to learn more about the workflow constructor function's constraints.
...
There are many ways to execute tasks asynchronously in Medusa, such as [scheduling a job](https://docs.medusajs.com/docs/learn/fundamentals/scheduled-jobs) or [handling emitted events](https://docs.medusajs.com/docs/learn/fundamentals/events-and-subscribers).
...
Refer to the [Scheduled Jobs](https://docs.medusajs.com/docs/learn/fundamentals/scheduled-jobs) documentation to learn more about scheduled jobs.
...
- Allow triggering migrations from the Medusa Admin dashboard using [Admin Customizations](https://docs.medusajs.com/docs/learn/fundamentals/admin). This feature is available in the [Example Repository](https://github.com/medusajs/example-repository/tree/main/src/admin).
